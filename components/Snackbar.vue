<template>
  <!-- <div v-if="show" class="pointer-events-none fixed top-0 left-0 z-30 h-full w-full"> -->
    <!-- pointer-events-none  -->
    <div v-if="show" id="toast-undo" class="z-30 fixed opacity-95 pointer-events-auto  bottom-3 left-3 flex w-full max-w-xs items-center rounded-lg bg-white p-2 pl-4 text-gray-500 shadow dark:bg-gray-800 dark:text-gray-400 cursor-pointer" role="alert">
      <div class="text-sm font-normal">
        <slot>
    <svg class="fill-current inline-block" xmlns="http://www.w3.org/2000/svg" height="24" width="24"><path d="M7 21q-.825 0-1.412-.587Q5 19.825 5 19V6H4V4h5V3h6v1h5v2h-1v13q0 .825-.587 1.413Q17.825 21 17 21ZM17 6H7v13h10ZM9 17h2V8H9Zm4 0h2V8h-2ZM7 6v13Z" /></svg>
