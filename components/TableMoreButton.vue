<template>
  <div class="group/action mx-auto h-9 w-9 flex justify-center items-center cursor-pointer rounded-full hover:bg-primary-light/20 transition-colors">
    <svg class="group-hover/action:fill-primary/70" xmlns="http://www.w3.org/2000/svg" height="20" width="20">
      <path
